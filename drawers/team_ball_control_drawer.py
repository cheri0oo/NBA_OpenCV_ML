...
class TeamBallControlDrawer:
    ...
    def get_team_ball_control(self, player_assignment, ball_aquisition):
        ...
        for player_assignment_frame, ball_aquisition_frame in zip(player_assignment, ball_aquisition):
            ...
            team_id = int(player_assignment_frame[ball_aquisition_frame])
    ...
    def draw_frame(self, frame, frame_num, team_ball_control):
        ...
        rect_y1 = int(frame_height * 0.72)
        rect_x2 = int(frame_width * 0.99)
        rect_y2 = int(frame_height * 0.92)

        # Text positions
        text_x = int(frame_width * 0.65)
        text_y1 = int(frame_height * 0.78)
        text_y2 = int(frame_height * 0.84)
        text_y3 = int(frame_height * 0.90)
        ...
        loose_num_frames = np.sum(team_ball_control_till_frame == -1)
        ...
        loose = loose_num_frames / total_frames
        ...
        cv2.putText(frame, f"Loose / unknown: {loose*100:.2f}%", (text_x, text_y3),
                    cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 0, 0), font_thickness)
